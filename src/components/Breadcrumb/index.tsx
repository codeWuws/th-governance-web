...
const Breadcrumb: React.FC<BreadcrumbProps> = ({ items, className }) => {
    ...
    const routeMap: Record<string, BreadcrumbItem> = {
        ...
        '/data-quality-control/flow-management': { title: '质控流程管理' },
        '/data-quality-control/execution-history': { title: '质控执行历史' },
        '/data-quality-control/text': { title: '可靠性质控' },
        '/data-quality-control/comprehensive': { title: '及时性质控' },
        '/data-quality-control/completeness': { title: '完整性质控' },
        '/data-quality-control/basic-medical-logic': { title: '一致性质控' },
        '/data-quality-control/core-data': { title: '准确性质控' },
